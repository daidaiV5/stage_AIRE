...
for (age_class, sex, organ), path_m in dico_matrices.items():
    for segthr in thrs:
        for repeat_time in range(1,repeat_times+1):
            ...
            segpath2 = os.path.join(outpath, repeat_time,f"{radical}_filtered_positive_cor_{segthr}.csv")
            ...
            nodes2 = os.path.join(outpath, repeat_time,f"{radical}_filtered_positive_cor_{segthr}_nodes.txt")
